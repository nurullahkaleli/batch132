...
public class Student {
    ...
    /*
        1)When we type code, we may need to hide same data for same reasons.
          "Encapsulations" means "hiding data"
        ...
        3)In getters;
            ...
            iii)"Method Name" should have "get + <Variable Name>" structure
                Note: If data type of the variable is "boolean", make the "Method Name" structure like "is+<Variable Name>"
         ...
         5)In setters;
          ...
          6) If you to create a "hidden", "updatable" but "not readable" variable; i) Make access modifier "private"
