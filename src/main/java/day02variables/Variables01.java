...
public class Variables01 {
    public static void main(String[] args) {
        ...
        /* Data Types
        1) integer (int):We use "integer" data type for whole numbers. The minimum value of integer is -2,147,483,648
        and the maximum value for integer data type is 2,147,483,647
        integer variables use  32 bits in memory.

        2) short: It is used for numeric values. The minimum value of short is -32,768 an maximum value is
        ...
        4) Long : It is used for whole numbers. The minimum value for lons is -9,223,372,036,854, 755,808 and maximum value is
         ...
         */
                ...
                int populationOfGermanny = 80000000;

        System.out.println("populationOfGermanny = " + populationOfGermanny);


        //Note:Java accepts long values as integer in default. BUt if your value is grater then the maximum value of
        //integers, you will get error and to fix that error you to put "L" to the end of the numeric.
        long populationOfWord = 7000000000L;
        int populationOfChina = 1400000000;
        ...
        1)float: It is used for decimal values ( Like 12.99, 34.89
          float values use 37 bits in memory

          when you create a float object, you have to use "f" or "F" at the and of the value
        ...
        2) char==> used for just a single character  values ==> "a" or "K" It uses 16 bit og memory.
