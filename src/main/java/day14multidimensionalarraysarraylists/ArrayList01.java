...
public class ArrayList01 {
    ...
    public static void main(String[] args) {
        ...
        /*
            1) To create an "Array" we need to declare " the number of element" at the beginning but
        ...
        //      add() method puts the element in "insertion order"
        ages.add(13);
        ages.add(9);
        ages.add(21);
        ...
        // ages.addAll(prices);; add "prices" list element into the "ages" list element
        ages.addAll(prices);
       ...
       // System.out.println(prices); //[]
                        ...
                        //How to check is a specific element exist in a list
        ...
        System.out.println(r2);  //true
                        ...
                        //How to check if two list same or not
