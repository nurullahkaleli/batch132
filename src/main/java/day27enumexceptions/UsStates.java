...
public enum UsStates {
    ...
    /*
           Enum is a storage to store constant data your applications needs.
           For example:For "Car Sale" application you need "Car Makes" that is why you have to store "Car Makes" in your applications
