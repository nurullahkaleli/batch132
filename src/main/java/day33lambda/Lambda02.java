...
public class Lambda02 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getMultiplication(13,11));
        System.out.println(getFactorial(-5));
        System.out.println(getSumOfEvensBetweenTwoIntegers(3,10));
        System.out.println(getSumOfDigitsOfGivenIntegersInTheGivenRange(45,47));
    ...
    public static int getSumOfDigitsOfGivenIntegersInTheGivenRange(int starting, int ending){
