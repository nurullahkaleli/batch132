...
public class Honda implements Ac, Engine {
    ...
    /*
        ...
        6) Interfaces are "fully abstract", I mean "Interfaces"  cannot have concrete methods, all methods in an interface
           must be abstract method. As you know "abstract method" must be implemented by "concrete child classes", If you want a developer
        ...
        7) To make an "interface" parent of a "Concrete Class" use "implements" keyword instead of "extends"
           ...
           *To make a "class" parent of an "interfaces" is impossible

           Interfaces(Parent) --> Class: implements
           Interfaces(Parent) --> Interface:extends
        ...
        9)Interfaces do not have "constructor" that is why you cannot create object from an interface.
          As you remember, we cannot object from "abstract class" as well.
          But "abstract classes" have constructor, the constructors cannot create object.

          As a summery, abstract structures cannot give you object.
       ...
       11) It is allowed to create methods with the same name different parent interfaces.
           But if you create methods with the same name different parent interfaces, make
